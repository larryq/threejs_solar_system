...
// node_modules/lamina/vanilla.js
...
var Depth = class _Depth extends Abstract {
  constructor(props) {
    super(_Depth, {
      name: "Depth",
      ...props
      ...
      const mapping = _Depth.getMapping(self.uuid, self.mapping);
...
Depth.fragmentShader = `   
  ...
  `;
var Color2 = class _Color extends Abstract {
  constructor(props) {
    super(_Color, {
      name: "Color",
      ...props
...
Color2.fragmentShader = `   
  ...
  `;
var Noise = class _Noise extends Abstract {
  constructor(props) {
    super(_Noise, {
      name: "noise",
      ...props
      ...
      const noiseFunc = _Noise.getNoiseFunction(self.type);
      const mapping = _Noise.getMapping(self.mapping);
...
Noise.fragmentShader = `   
  ...
  `;
var Fresnel = class _Fresnel extends Abstract {
  constructor(props) {
    super(_Fresnel, {
      name: "Fresnel",
      ...props
...
Fresnel.fragmentShader = `   
  ...
  `;
var Gradient = class _Gradient extends Abstract {
  constructor(props) {
    super(_Gradient, {
      name: "Gradient",
      ...props
      ...
      const mapping = _Gradient.getMapping(self.mapping);
...
Gradient.fragmentShader = `   
  ...
  `;
var Matcap = class _Matcap extends Abstract {
  constructor(props) {
    super(_Matcap, {
      name: "Matcap",
      ...props
...
Matcap.fragmentShader = ` 
  ...
  `;
var Texture2 = class _Texture extends Abstract {
  constructor(props) {
    super(_Texture, {
      name: "Texture",
      ...props
...
Texture2.u_alpha = 1;
Texture2.u_map = void 0;
Texture2.vertexShader = `
    varying vec2 v_uv;
...
Texture2.fragmentShader = ` 
  ...
  `;
var Displace = class _Displace extends Abstract {
  constructor(props) {
    super(_Displace, {
      name: "Displace",
      ...props
      ...
      const noiseFunc = _Displace.getNoiseFunction(self.type);
      const mapping = _Displace.getMapping(self.mapping);
...
Displace.vertexShader = `
    ...
    `;
var Normal = class _Normal extends Abstract {
  constructor(props) {
    super(_Normal, {
      name: "Normal",
      ...props
...
var LayerMaterial = class extends CustomShaderMaterial {
  constructor({
    color,
    alpha,
    lighting,
...
//# sourceMappingURL=lamina_vanilla.js.map
